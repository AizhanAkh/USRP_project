...
struct background
{
  ...
  double cs2_fld; /**< \f$ c^2_{s~DE} \f$: sound speed of the fluid
		     ...
		     newtonian gauge!!!) */
  double Omega0_efld; /**< \f$ \Omega_{0 0} \f$: fluid*/
  double w0_efld; /**< \f$ w0_{0 0} \f$: constant additional fluid equation of state parameter */
  ...
  int index_bg_rho_efld;      /**< fluid density */
  ...
  short has_efld;      /**< presence of extra fluid with constant w0 */
